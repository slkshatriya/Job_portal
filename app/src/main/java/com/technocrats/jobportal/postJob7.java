...
public class postJob7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_job7);

        storageReference = FirebaseStorage.getInstance().getReference("Editor");
        databaseReference = FirebaseDatabase.getInstance().getReference("Editor");
        ...
        progressDialog = new ProgressDialog(postJob7.this);
