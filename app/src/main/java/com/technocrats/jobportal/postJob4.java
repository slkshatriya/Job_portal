...
public class postJob4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_job4);

        storageReference = FirebaseStorage.getInstance().getReference("Medical");
        databaseReference = FirebaseDatabase.getInstance().getReference("Medical");
        ...
        progressDialog = new ProgressDialog(postJob4.this);
    ...
    private void sendMail() {
        ...
        try {
            ...
            mimeMessage.setText("Hello There, \n\nYour job post are live in the Medical find job section. \n\n Cheers!\nTeam Technocrats");
