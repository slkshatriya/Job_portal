...
public class postJob1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference = FirebaseStorage.getInstance().getReference("Design");
        databaseReference = FirebaseDatabase.getInstance().getReference("Design");
        ...
        progressDialog = new ProgressDialog(postJob1.this);
    ...
    private void sendMail() {
        ...
        try {
            ...
            mimeMessage.setText("Hello There, \n\nYour job post are live in the Design find job section. \n\n Cheers!\nTeam Technocrats");
