...
public class postJob2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference = FirebaseStorage.getInstance().getReference("It");
        ...
        progressDialog = new ProgressDialog(postJob2.this);
    ...
    private void sendMail() {
        ...
        try {
            ...
            mimeMessage.setText("Hello There, \n\nYour job post are live in the IT find job section. \n\n Cheers!\nTeam Technocrats");
