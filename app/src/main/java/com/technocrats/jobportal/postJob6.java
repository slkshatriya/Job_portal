...
public class postJob6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_job6);

        storageReference = FirebaseStorage.getInstance().getReference("Banking");
        databaseReference = FirebaseDatabase.getInstance().getReference("Banking");
        ...
        progressDialog = new ProgressDialog(postJob6.this);
    ...
    private void sendMail() {
        ...
        try {
            ...
            mimeMessage.setText("Hello There, \n\nYour job post are live in the Banking find job section. \n\n Cheers!\nTeam Technocrats");
